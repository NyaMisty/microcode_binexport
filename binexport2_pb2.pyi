...
class BinExport2(google.protobuf.message.Message):
    ...
    class Meta(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["architecture_name", b"architecture_name", "executable_id", b"executable_id", "executable_name", b"executable_name", "timestamp", b"timestamp"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["architecture_name", b"architecture_name", "executable_id", b"executable_id", "executable_name", b"executable_name", "timestamp", b"timestamp"]) -> None: ...
    ...
    class CallGraph(google.protobuf.message.Message):
        ...
        class Vertex(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["address", b"address", "demangled_name", b"demangled_name", "library_index", b"library_index", "mangled_name", b"mangled_name", "module_index", b"module_index", "type", b"type"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["address", b"address", "demangled_name", b"demangled_name", "library_index", b"library_index", "mangled_name", b"mangled_name", "module_index", b"module_index", "type", b"type"]) -> None: ...
        ...
        class Edge(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["source_vertex_index", b"source_vertex_index", "target_vertex_index", b"target_vertex_index"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["source_vertex_index", b"source_vertex_index", "target_vertex_index", b"target_vertex_index"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["edge", b"edge", "vertex", b"vertex"]) -> None: ...
    ...
    class Expression(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["immediate", b"immediate", "is_relocation", b"is_relocation", "parent_index", b"parent_index", "symbol", b"symbol", "type", b"type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["immediate", b"immediate", "is_relocation", b"is_relocation", "parent_index", b"parent_index", "symbol", b"symbol", "type", b"type"]) -> None: ...
    ...
    class Operand(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["expression_index", b"expression_index"]) -> None: ...
    ...
    class Instruction(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["address", b"address", "mnemonic_index", b"mnemonic_index", "raw_bytes", b"raw_bytes"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["address", b"address", "call_target", b"call_target", "comment_index", b"comment_index", "mnemonic_index", b"mnemonic_index", "operand_index", b"operand_index", "raw_bytes", b"raw_bytes"]) -> None: ...
    ...
    class BasicBlock(google.protobuf.message.Message):
        ...
        class IndexRange(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["begin_index", b"begin_index", "end_index", b"end_index"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["begin_index", b"begin_index", "end_index", b"end_index"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["instruction_index", b"instruction_index"]) -> None: ...
    ...
    class FlowGraph(google.protobuf.message.Message):
        ...
        class Edge(google.protobuf.message.Message):
            ...
            def HasField(self, field_name: typing.Literal["is_back_edge", b"is_back_edge", "source_basic_block_index", b"source_basic_block_index", "target_basic_block_index", b"target_basic_block_index", "type", b"type"]) -> builtins.bool: ...
            def ClearField(self, field_name: typing.Literal["is_back_edge", b"is_back_edge", "source_basic_block_index", b"source_basic_block_index", "target_basic_block_index", b"target_basic_block_index", "type", b"type"]) -> None: ...
        ...
        def HasField(self, field_name: typing.Literal["entry_basic_block_index", b"entry_basic_block_index"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["basic_block_index", b"basic_block_index", "edge", b"edge", "entry_basic_block_index", b"entry_basic_block_index"]) -> None: ...
    ...
    class Reference(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["instruction_index", b"instruction_index", "instruction_operand_index", b"instruction_operand_index", "operand_expression_index", b"operand_expression_index", "string_table_index", b"string_table_index"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["instruction_index", b"instruction_index", "instruction_operand_index", b"instruction_operand_index", "operand_expression_index", b"operand_expression_index", "string_table_index", b"string_table_index"]) -> None: ...
    ...
    class DataReference(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["address", b"address", "instruction_index", b"instruction_index"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["address", b"address", "instruction_index", b"instruction_index"]) -> None: ...
    ...
    class Comment(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["instruction_index", b"instruction_index", "instruction_operand_index", b"instruction_operand_index", "operand_expression_index", b"operand_expression_index", "repeatable", b"repeatable", "string_table_index", b"string_table_index", "type", b"type"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["instruction_index", b"instruction_index", "instruction_operand_index", b"instruction_operand_index", "operand_expression_index", b"operand_expression_index", "repeatable", b"repeatable", "string_table_index", b"string_table_index", "type", b"type"]) -> None: ...
    ...
    class Section(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["address", b"address", "flag_r", b"flag_r", "flag_w", b"flag_w", "flag_x", b"flag_x", "size", b"size"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["address", b"address", "flag_r", b"flag_r", "flag_w", b"flag_w", "flag_x", b"flag_x", "size", b"size"]) -> None: ...
    ...
    class Library(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["is_static", b"is_static", "load_address", b"load_address", "name", b"name"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["is_static", b"is_static", "load_address", b"load_address", "name", b"name"]) -> None: ...
